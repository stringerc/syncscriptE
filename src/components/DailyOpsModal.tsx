    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="w-full max-w-2xl max-h-[85vh] rounded-2xl border border-white/10 bg-gradient-to-b from-[#0f1620]/40 to-[#0a0e18]/40 backdrop-blur-[64px] shadow-2xl flex flex-col overflow-hidden">
