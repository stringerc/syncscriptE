  ...
  const [groups] = useState<Group[]>([
    {
      ...
      memberCount: 8,
      members: [
        { id: 'user_002', name: 'Sarah Chen', avatar: '' },
        { id: 'user_003', name: 'Alex Kumar', avatar: '' },
        { id: 'user_004', name: 'Emily Rodriguez', avatar: '' },
      ],
    ...
    },
    {
      ...
      members: [
        { id: 'user_002', name: 'Sarah Chen', avatar: '' },
        { id: 'user_005', name: 'Marcus Thompson', avatar: '' },
      ],
    ...
    },
    {
      ...
      members: [
        { id: 'user_004', name: 'Emily Rodriguez', avatar: '' },
        { id: 'user_006', name: 'Priya Sharma', avatar: '' },
      ],
