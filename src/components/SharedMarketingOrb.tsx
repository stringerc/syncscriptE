...
const LANDING_KEYFRAMES: OrbKeyframe[] = [
  ...
  { at: 0.06, expand: 1.0,  spread: 0,    noiseAmp: 1.1, speed: 1.1, tiltX: 0.55, rotSpeed: 1.2, brightness: 1.2, color1: '#06b6d4', color2: '#14b8a6', opacity: 1.5, posX: 0.3,  posY: -0.2, scale: 1.0  },
  // Problem with productivity — CHAOS: scatter, warm colors, high noise
  { at: 0.12, expand: 1.0,  spread: 0.5,  noiseAmp: 2.8, speed: 2.2, tiltX: 0.7,  rotSpeed: 2.5, brightness: 1.4, color1: '#f97316', color2: '#ef4444', opacity: 1.6, posX: -0.5, posY: -0.4, scale: 1.0  },
  // Transition: chaos calming down
  { at: 0.17, expand: 1.0,  spread: 0.15, noiseAmp: 1.5, speed: 1.4, tiltX: 0.5,  rotSpeed: 1.5, brightness: 1.1, color1: '#22d3ee', color2: '#10b981', opacity: 1.5, posX: 0,    posY: -0.3, scale: 1.0  },
  ...
  { at: 0.38, expand: 1.0,  spread: 0,    noiseAmp: 0.8, speed: 0.6, tiltX: 0.5,  rotSpeed: 0.7, brightness: 1.1, color1: '#059669', color2: '#0d9488', opacity: 1.5, posX: 0,    posY: 0,    scale: 1.0  },
  // How it Works — flowing energy, journey
  { at: 0.46, expand: 1.0,  spread: 0.1,  noiseAmp: 1.6, speed: 1.6, tiltX: 0.6,  rotSpeed: 1.8, brightness: 1.3, color1: '#0ea5e9', color2: '#14b8a6', opacity: 1.5, posX: 0.4,  posY: -0.2, scale: 1.0  },
  ...
  { at: 0.58, expand: 1.0,  spread: 0.12, noiseAmp: 1.8, speed: 2.5, tiltX: 0.8,  rotSpeed: 3.0, brightness: 1.5, color1: '#22d3ee', color2: '#67e8f9', opacity: 1.6, posX: 0.2,  posY: -0.3, scale: 1.0  },
  // Everything You Need — grand, complete, bright
  { at: 0.66, expand: 1.0,  spread: 0,    noiseAmp: 0.8, speed: 0.8, tiltX: 0.5,  rotSpeed: 0.8, brightness: 1.4, color1: '#14b8a6', color2: '#0d9488', opacity: 1.6, posX: 0,    posY: 0,    scale: 1.0  },
  // See the Difference — split energy
  { at: 0.74, expand: 1.0,  spread: 0.2,  noiseAmp: 1.3, speed: 1.2, tiltX: 0.6,  rotSpeed: 1.0, brightness: 1.2, color1: '#0ea5e9', color2: '#f59e0b', opacity: 1.4, posX: -0.2, posY: 0,    scale: 1.0  },
  // FAQ — peaceful, warm resolution
  { at: 0.84, expand: 1.0,  spread: 0,    noiseAmp: 0.5, speed: 0.35,tiltX: 0.35, rotSpeed: 0.3, brightness: 0.9, color1: '#f59e0b', color2: '#fbbf24', opacity: 1.2, posX: 0,    posY: 0.2,  scale: 1.0  },
