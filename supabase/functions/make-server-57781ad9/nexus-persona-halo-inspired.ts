/**
 * SYNC: keep identical to integrations/nexus-persona/nexus-persona-halo-inspired.ts
 * (Duplicated here so Supabase Edge deploy bundles without repo-root imports.)
 */
