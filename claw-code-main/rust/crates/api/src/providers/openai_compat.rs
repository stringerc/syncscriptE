...
const NVIDIA_MAX_REQUEST_BODY_BYTES: usize = 52_428_800; // 50MB
...
impl OpenAiCompatConfig {
    ...
    /// NVIDIA NIM (Inference Microservices) — OpenAI-compatible endpoint.
    /// Hosts Meta Llama, Mistral, and other open models at integrate.api.nvidia.com.
    #[must_use]
