...
// import scriptsRoutes from './routes/scripts'; // File deleted
...
import aplRoutes from './routes/apl';
...
const io = new Server(server, {
  cors: {
    origin: [
      ...
      "http://localhost:3000",
      "https://syncscript-e-7fzp.vercel.app",
      /^https:\/\/.*\.vercel\.app$/
    ],
    methods: ["GET", "POST"],
    credentials: true
...
// app.use('/api/scripts', scriptsRoutes); // File deleted
